...
#### The core idea is that applications do not need to wait for readiness events. Instead of polling or blocking, an application submits operations to the Submission Queue and later reads exact completion results from the io_uring buffers
